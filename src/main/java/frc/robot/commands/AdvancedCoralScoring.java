...
public class AdvancedCoralScoring extends Command {
  /** Creates a new AdvancedCoralScoring. */
  private CoralScoring coralScoring;

  private final double reverseDelaySec = .225;
  private Timer timer;

  public AdvancedCoralScoring(CoralScoring coralScoring) {
  ...
  @Override
  public void execute() {
    if (timer.hasElapsed(reverseDelaySec)) {
      coralScoring.scores();
    } else {
